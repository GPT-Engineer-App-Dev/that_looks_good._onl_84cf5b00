    ...
    <Box bg="#002F5D" minH="100vh" py={10}>
      <Container maxW="container.md">
        <VStack spacing={5}>
          ...
          <FormControl id="pictureOption">
            <FormLabel color="white">Is a picture of the sample sufficient?</FormLabel>
            <RadioGroup name="pictureOption" value={formData.pictureOption} onChange={(value) => setFormData({ ...formData, pictureOption: value })}>
              <Stack direction="row">
          ...
          <FormControl id="sampleLocations">
            ...
            <Input name="sampleLocations" type="file" accept="image/*" onChange={handleFileUpload} color="white" />
          </FormControl>
          <FormControl id="logoUpload">
            <FormLabel color="white">Logo/Design Upload</FormLabel>
            <Input name="logoUpload" type="file" accept=".pdf,.png,.jpg,.jpeg,.bmp,.ai,.plt" multiple onChange={handleFileUpload} color="white" />
          </FormControl>
